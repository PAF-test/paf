...
public class PaymentService
{
		...
		public String insertItem(@FormParam("projectId") String projectId,
							@FormParam("totalPrice") String totalPrice)
							
		{
				String output = paymentObj.insertItem(projectId, totalPrice);
				return output;
		}
		...
		public String updateItem(String itemData)
		{
			...
			String totalProjects = itemObject.get("projectId").getAsString();
