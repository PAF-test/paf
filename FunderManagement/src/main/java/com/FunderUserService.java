...
@Path("/Funder")
public class FunderUserService
{
		Funder regObj = new Funder();
		@GET
		@Path("/")
		...
		{
				String output = regObj.insertItem(userName, userPassword, userEmail, userPhone);
				return output;
		}
		...
		public String updateItem(String fundId)
		{
			...
			String output = regObj.updateItem(id, userName, userPassword, userEmail,userPhone);
			return output;
		}
