...
{ 		//A common method to connect to the DB
	...
	public String insertItem(String projectId, String totalPrice)
	{
		String output = "";
		...
		try
		{
			...
			String query = " insert into payments (`paymentId`,`projectId`,`totalPrice`)"
					+ " values (?, ?, ?)";
	...
	{ 
		...
		{ 
			 ...
			 output = "<table border='1'><tr><th>Payment Id</th><th>Total Projects</th><th>Total Price</th>"; 
	...
	public String updateItem(String paymentId, String ProjectId, String totalPrice)
	{ 
		String output = ""; 
		...
		{ 
			...
			if (con == null) 
			{
			 ...
			 // create a prepared statement
			 String query = "UPDATE payments SET projectId=?,totalPrice=? WHERE paymentId=?"; 
