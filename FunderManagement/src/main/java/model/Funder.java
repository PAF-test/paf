...
{ 		//A common method to connect to the DB
	...
	public String insertItem(String userName, String userPassword, String userEmail, String userPhone)
	{
		String output = "";
		...
		try
		{
			...
			String query = " insert into funders (`id`,`userName`,`userPassword`,`userEmail`, `userPhone`)"
					+ " values (?, ?, ?, ?, ?)";
	...
	public String updateItem(String id, String userName, String userPassword, String userEmail, String userPhone)
	{ 
		String output = "";
		...
		{ 
			 ...
			 // create a prepared statement
			 String query = "UPDATE funders SET userName=?,userPassword=?, userEmail=?, userPhone=? WHERE id=?"; 
